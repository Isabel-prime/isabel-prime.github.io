...
Mixed in with the open problems were a scattering of known results with short, not-too-technical proofs. It was up to the audience to identify and provide proofs for these `trivial' results. <a href="/files/trivial-notions-open-problems.pdf" title="notes"><i class="fa-regular fa-file"></i></a> (_caveat lector_)